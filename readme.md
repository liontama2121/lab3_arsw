...
1. Revise el funcionamiento del programa y ejecútelo. Mientras esto ocurren, ejecute jVisualVM y revise el consumo de CPU del proceso correspondiente. A qué se debe este consumo?, cual es la clase responsable?
   ...
   El culpable de que se consuma tanta CPU es la clase Consumer porque todo el tiempo estaba procesando sin tener ninguna pausa por estar dentro del While infinito.
...
- Lo anterior, garantizando que no se den condiciones de carrera.
		...
		Lo que hicimos para lograr que que se detengan es hacer uso de interrupt() para todos los threads que no se ubicen detenido antes de que se interrumpiera.
